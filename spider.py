...
class Spider:
    ...
    def __init__(self, project_name, base_url, domain_name):
        ...
        Spider.forbidden_file = Spider.project_name + '/forbidden.txt'
    ...
    def boot():
        ...
        Spider.forbidden = file_to_set(Spider.forbidden_file)
    ...
    def update_files():
        ...
        set_to_file(Spider.forbidden, Spider.forbidden_file)
